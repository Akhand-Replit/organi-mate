...
const BranchCreateEmployee: React.FC = () => {
  const { user } = useAuth();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!user?.company_id || !user?.branch_id) {
      toast({
        ...
        description: "You need to be logged in as a branch manager to create employees.",
        variant: "destructive",
      });
      return;
    }
      ...
      <div className="flex flex-col gap-6 p-4">
        ...
        <Card className="max-w-2xl mx-auto w-full">
          <CardHeader>
            ...
            <CardDescription>
              Create an employee or assistant manager account for your branch.
            </CardDescription>
          </CardHeader>
...
export default BranchCreateEmployee;
