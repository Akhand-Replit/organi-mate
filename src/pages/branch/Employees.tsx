...
const BranchEmployees: React.FC = () => {
  ...
  const { data: employees, isLoading } = useQuery({
    queryKey: ['branch-employees', user?.branch_id],
    queryFn: async () => {
    ...
    <BranchLayout>
      <div className="p-6">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-3xl font-bold tracking-tight">Branch Employees</h1>
          <Link to="/branch/create-employee">
        ...
        <Card>
          <CardHeader>
            <CardTitle>All Branch Employees</CardTitle>
            <CardDescription>
          ...
          <CardContent>
            {isLoading ? (
              ...
              <Table>
                <TableCaption>List of all employees in your branch.</TableCaption>
                <TableHeader>
                  <TableRow>
