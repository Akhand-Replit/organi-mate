  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!user?.company_id) {
      toast({
        ...
        description: "You need to be logged in as a company to create employees.",
        variant: "destructive",
      });
      return;
    }
      ...
      <div className="flex flex-col gap-6 p-4">
        ...
        <Card className="max-w-2xl mx-auto w-full">
          <CardHeader>
            ...
            <CardDescription>
              Create an employee account with the appropriate role and branch assignment.
            </CardDescription>
          </CardHeader>
          <form onSubmit={handleSubmit}>
            ...
            <CardFooter>
              <Button type="submit" className="w-full" disabled={isLoading || isFetchingBranches}>
                {isLoading ? (
